  ...
  execute: async (interaction, user) => {
    try {
      ...
      if (guildMember) {
        ...
        //   }
        // }
        await UpdateRolesDonation(interaction.member, uuid, true);
      } else {
        ...
        //   }
        // }
        await UpdateRolesDonation(interaction.member, uuid, false);
      }
      ...
      //     staffemoji: interaction.member.roles.cache.has("1069080675342360606")? ":star:" : "",
      //   }),
      //   "Updated Roles",
      // );
